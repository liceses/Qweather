...
weatherBackgroundDebugPanel:
 -  调节滑条时面板透明,只剩滑条,方便观察 V
 - 添加一个演示天气动态背景的炫技功能:展示一天的天文变化,包括所有的天气循环播放时间从0到24,每种天气都过一遍,播放的时候debug面板透明,鼠标点画面退出播放
